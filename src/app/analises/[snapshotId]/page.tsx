...
import { obterRepositorioLeituraResultadoAnalise } from '@/features/analises/services/composicao-resultado-analise-servidor'
...
export default async function PaginaResultadoAnalise({ params }: { params: Promise<{ snapshotId: string }> }) {
  ...
  const resumo = await lerResultadoAnalise(snapshotId, { repositorio: obterRepositorioLeituraResultadoAnalise() })
